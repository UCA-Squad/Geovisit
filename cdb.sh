...
#mysqldump -u $MUSER -p$MPASS -h $MHOST $MDB > geovisit_dump.sql
...
do
	...
	$MYSQL -u $MUSER -p$MPASS -h $MHOST $MDB -e "SET FOREIGN_KEY_CHECKS = 0;drop table $t;SET FOREIGN_KEY_CHECKS = 1;"
done
