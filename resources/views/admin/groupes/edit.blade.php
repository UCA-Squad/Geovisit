    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h1 class="etapes-titre">MODIFIER GROUPE</h1>
            </div>
            <div class="modal-body">
                ...
                {{ Form::open(['route' => ['groupe.update', 'groupe' => $groupe_edited->id], 'method' => 'post', 'id' => 'formgroupe']) }}
                <h3 class="etapes-soustitre">NOM DU GROUPE</h3>
                <table class="admin-table-input-group">
                    <tr>
                        <td class="td-label">GROUPE</td>
                        <td>
                            {{ Form::text('titre', !is_null(old('titre')) ? old('titre') : $groupe_edited->titre, ['id' => 'titreg', 'placeholder' => 'Saisir un nom pour le groupe', 'class' => 'table-admin-inputtext', 'style' => ($errors->has('titre') ? 'border: 1px solid #A94442 !important;' : '')]) }}
                        </td>
                ...
                <table id='etudiants-list' class="table table-striped table-bordered" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ Form::checkbox('etudiants[]', $etd->id, 
                                        ((is_array(old('etudiants')) && in_array($etd->id, old('etudiants'))) ? true : 
                                        ($groupe_edited->etudiants()->where('etudiants.id', $etd->id)->exists() ? true : false))) }} </td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
