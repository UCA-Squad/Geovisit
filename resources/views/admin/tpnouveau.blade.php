...
@section('content')
<script>var delay = 300000;</script>
...
<div class="row general" style="padding:0; margin:0;" id="editable">
    ...
    {{ Form::hidden('etat_brouillon', $etat_actuel, ['id' => 'etat_brouillon']) }}
    ...
    <fieldset id="fieldintro">
        <div class="row" style="margin:0;">
            ...
            <table class="admin-table-input-group">
                <tr>
                    ...
                    <td class="td-input">
                        @if($id_session_site == "")
                        <a href="#" id="btn_site" style="color:#ccc; text-decoration: none; display:block;">
                            Cliquez ici pour selectionner un site<img src="{{URL::asset('css/img/ICONE_PLUS.png') }}" style="float:right;">
                        </a>
                        {{ Form::hidden('id_site', '', ['id' => 'id_site']) }}
                        @elseif($id_session_site != "")
                        <a href="#" id="btn_site" style="{{ ($nom_site == "")?'color:#ccc;':'color:#000;' }}text-decoration: none; display:block;">
                            {{ $nom_site }}<img src="{{URL::asset('css/img/ICONE_PLUS.png') }}" style="float:right;">
                        </a>
                        {{ Form::hidden('id_site', $id_session_site, ['id' => 'id_site']) }}
                        @endif
                    </td>
                    <td style="border-collapse:initial; "> * <span id="erreur_site_tp" class="erreurs_admin">Vous devez selectionner un site pour votre Tp</span>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="row" style="margin:0;">
            ...
            <table class="admin-table-input-group">
                ...
                <td class="td-input">
                    {{ Form::text('titre_tp', $titre_tp, ['id' => 'titre_tp', 'class' => 'table-admin-inputtext']) }}
                </td>
            ...
            <table class="admin-table-input-group">
                ...
                <td class="td-input">
                    {{ Form::text('descr_tp', $descr_tp, ['id' => 'descr_tp', 'class' => 'table-admin-inputttext']) }}
                </td>
                <td style="border-collapse:initial; "> * 
                </td>
            </table><br>

            <h3 class="etapes-soustitre">A suivre formulaire sommaire</h3>
        </div>
        </br>
        ...
        <div class="row" style="margin:0;">
            ...
            <div class="row" style="margin:0px;">
                <div id="container_intro" class="container_intro" style="height:300px;" class="ui-sortable"></div>
        ...
        <div class="row" style="margin:0;">
            ...
            <a href="{{route('showsite', $id_session_site)}}" id="intro_voir_site2" target="_blank" {{(!empty($id_session_site))?'':'style=display:none'}}><img src='{{{ asset("/css/img/SOMMAIRE_ICONE_VOIR.png") }}}'> Voir Video / Carte</a>
            <div class="row" style="margin:0;">
                <div id="slider_ateliers" class="row" style="height:200px; margin:0; width:100%; padding:100px 0 50px 0;">
                    <p class="aucun_element">Aucun Site sélectionné.</p>
                </div>
            </div>
            ...
            <div class="row" style="margin:0;">
                ...
                <div id="receptacle-ateliers" style="width:100%;">
                    <!-- EN ATTENTE AJAX -->
                    <p class="aucun_element">Aucun Atelier(s) sélectionné(s).</p>
                </div>
            </div>
        </div>
    ...
    <fieldset id="fieldexercices">
        <h1 class="etapes-titre">Etape 06 / Les Exercices</h1>
        <div id="receptacle-exercices-placement" class="receptacle-exercices-placement" style="width:100%;">
            <p class="aucun_element">Aucun Atelier(s) crée(s).</p>
        </div>
        ...
        <div class="bloc-boutons-submits"><input type="button" name="previous" class="previous action-button" value="PRECEDENT" />
            <input type="button" name="next" class="next action-button" value="CONTINUER" /></div>
    </fieldset>
    <!-- FIN DES EXERCICES -->
    ...
    <fieldset id="fieldpublication">
        ...
        <div id="bloc-info-publier" class="row" style="height:150px; margin:0;">
            ...
            <div id="bloc-infos" class="col-lg-4" style="padding:auto;">
                <ul style="margin:auto;">
                    <li style="width:25%;">
                        <?php $listeAteliers = Session::has('selectionCheckboxesAteliers') ? count(Session::get('selectionCheckboxesAteliers')) : 0 ?>
                        <p id="nbre_atelier" class="chiffre-info">{{$listeAteliers}}</p>
                        <p class="type-info">ateliers</p>
                    </li>
                    <li style="width:25%;">
                        <?php $totexercices = Session::get('nbexercicesTotal') ?>
                        <p id="nbre_exercice" class="chiffre-info">{{$totexercices}}</p>
                        <p class="type-info">exercices</p>
                    </li>
                    <li style="width:25%;">
                        <?php $classexercices = Session::has('selectionCheckboxesgroupes') ? count(Session::get('selectionCheckboxesgroupes')) : 0 ?>
                        <p id="nbre_groupe" class="chiffre-info">{{$classexercices}}</p>
        ...
        <div class="row" style="margin:0;">
            ...
            <div id="receptacle_groupes" class="receptacle_groupes">
                <p class="aucun_element"> Aucun Groupe(s) ajouté(s).</p>
            </div>
            <div class="row" style="margin:0;"><span id="erreur_publication_groupes_tp" class="erreurs_admin">Vous devez assigner au moins un groupe à votre Tp</span></div>
        </div>
        ...
        <div class="bloc-boutons-submits"><input type="button" name="publier_plustard" id="publier_plustard" class="submit action-button" style="background:none; color:red;" value="PUBLIER PLUS TARD" /></div>
    </fieldset>	
    <!-- FIN DE PUBLICATION -->
...
<div id="popup_sites_chx" class="dialog_operations">
    <div id="contenus_popup_sites_chx" class="contenu-cacher">
        <div id="choix_sites" class="content_popup_admin">
            <a href="#" id="close_sites" class="fermerpopup" style="font-family: 'Lato', sans-serif;
               font-weight: 300;
               color:grey;
               font-size:20px; float:right; padding:10px; ">&times;</a>
            <h1 class="etapes-titre">Etape 01 / Choix du site</h1><br><br>
            <div class="row" style="text-align:center; width:100%; margin-top:40px;">
                <div id="slideshow" style="text-align:center;margin: auto;">
                    <input type="hidden" name="token2" value="{{ csrf_token() }}">
                    ...
                    <fieldset id="site_{{ $site->id }}" class="fields-site-popup" style="width:90%; margin-right:auto; margin-left:auto;">
                        <div class="row">
                            ...
                            @else
                            <a href="#" id="fleche_gauche_site_{{ $site->id }}" class="fleche_gauche_site col-lg-3"><div class="fleche_gauche_site_img"></div></a>
                            @endif	
                            <div class="col-lg-6">
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-7">
                                    ...
                                    <a href="{{route('showsite', $site->id)}}" id="intro_voir_site" style="color:#f96332; float:right;" target="_blank">Voir le site </a>
                                </div>
                            </div>
                            @if($sites->last() == $site)
                            <div class="col-lg-3"></div>
                        ...
                        <div class="row">
                            <br><div class="bloc-boutons-submits"><a href="#" id="submit_chx_site_{{ $site->id }}" class="submit action-button valid-choix-site">Valider</a></div>
                        </div>
                    </fieldset>
                    @endforeach	
                </div>	
                            ...
                            <div class="panel" id="paneladmin">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        ...
                                        {{ Form::checkbox('chx_groupe[]', $groupe->id,Session::has('enmodification') ? (count($groupes_selectionnes) > 0 ? (in_array($groupes->id, array_column($groupes_selectionnes->toArray(), 'id')) ? true : false) : false) : false, ['style' => 'float: right;margin-left: 20px;']) }}
        ...
        $("#btn_groupe_assign").click(function () {            
            ...
            $("#submit_chx_groupe").click(function () {
                ...
                $.ajax({
                    ...
                    data: {'choix': groupes_tp, '_token': $('input[name=token2]').val()},
                    dataType: "json"}
