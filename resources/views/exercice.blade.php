...
<script>
	...
	$("#overlay_click").on('wheel', function(e) {
		...
		var delta = 15 * e.originalEvent.deltaY;
		...
		TweenLite.to($("#overlay_contenu"), 0.7, {top: -scroll_value + "px"});		
		TweenLite.to($("#scrollbarrinette"), 0.7, {top: ((($("#scrollbarrette").height() - $("#scrollbarrinette").height())*scroll_value)/($("#overlay_contenu").height()-$("#overlay_click").height())) + "px"});	
	});
